runtime inits/plug.vim
runtime inits/plug_config.vim

runtime inits/initial.vim
runtime inits/theme.vim
runtime inits/filetype.vim
runtime inits/key-mapping.vim
